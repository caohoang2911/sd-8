        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img src="https://i.postimg.cc/ykyMtVZy/one-life.png" width="28" height="28" />
              <div style={{
                display: "flex",
                flexDirection: "column"
              }}>
                ...
                <div key={index} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ width: '25%', textAlign: "right" }}>
                      <span> {new Intl.NumberFormat().format(Number(sellPrice || 0) * Number(product.quantity || 0)) || 0}</span>
                    </div>
                  </div>
                </div>
              );
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span>{Boolean(shippingDiscountTotal) && "-"}{new Intl.NumberFormat().format(shippingDiscountTotal) || 0}</span>
            </div>
          </div>
          <div
              style={{ border: "1px dashed #000000", margin: "15px 0px", width: '100%' }}
